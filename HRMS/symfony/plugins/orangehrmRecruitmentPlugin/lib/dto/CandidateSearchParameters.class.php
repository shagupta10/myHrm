...
class CandidateSearchParameters {
    ...
    private $microResume;
    private $candidateVacancyId;
    private $referralId;
    private $candidateEmail;
    private $candidateContactNumber;
    private $vacancyNameWithNumbers;
    ...
    public function getCandidateContactNumber(){
	    return $this->candidateContactNumber;
    }
    
    public function setCandidateContactNumber($candidateContactNumber){
	    $this-> candidateContactNumber = $candidateContactNumber;
    }
    
    public function getCandidateVacancyId(){
    	return $this->candidateVacancyId;
    }
    
    public function setCandidateVacancyId($candidateVacancyId){
    	$this-> candidateVacancyId = $candidateVacancyId;
    }
    
    public function getMicroResume(){
    	return $this-> microResume;
    }
    
    public function setMicroResume($microResume){
    	$this-> microResume = $microResume;
    }
    ...
    public function setVacancyNameWithNumbers($params) {
    	$this->vacancyNameWithNumbers = $params;
    }
    
    public function getVacancyNameWithNumbers() {
    	$vacancyDetails = $this->getVacancyService()->getVacancyById($this->vacancyId);
        if (empty($vacancyDetails)) {
            $this->vacancyNameWithNumbers = "";
        } else {
            $this->vacancyNameWithNumbers = $vacancyDetails->getVacancyName()." [".$vacancyDetails->getNumberOfCandidateApplied()."]";
        }
    	return $this->vacancyNameWithNumbers;
    }
}
