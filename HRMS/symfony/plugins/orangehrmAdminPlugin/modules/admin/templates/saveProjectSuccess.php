            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li id="<?php echo "projectAdmin_" . $i ?>" class="<?php echo ($i == 1) ?'':'noLabel'; ?>">
                        ...
                        <?php echo $form['projectAdminType_' . $i]->render(array("class" => "formInputProjectAdmin", "style" => "margin-left: 5px;")); ?>
                        <?php if($i != 1) { ?>
...
<script type="text/javascript">
    ...
    var urlForGetActivity = '<?php echo url_for("admin/getActivityListJson?projectId="); ?>';
    ...
    var adminCount = '<?php echo $existingAdmins; ?>'
