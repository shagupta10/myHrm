...
class JobInterviewForm extends BaseForm {
    ...
    public function configure() {
        ...
        || $this->selectedAction == WorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_SHEDULE_2ND_INTERVIEW)) {
...
//creating widgets
        ...
        $this->setValidators(array(
            ...
            'note' => new sfValidatorString(array('required' => true)),
    ...
    private function setDefaultValues($interviewId) {
        ...
        $this->setDefault('interviewer_1', $interviewers[0]->getEmployee()->getFirstAndLastNames());
        for ($i = 1; $i <= count($interviewers); $i++) {
            $this->setDefault('interviewer_' . $i, $interviewers[$i - 1]->getEmployee()->getFirstAndLastNames());
        }
    ...
    protected function saveCandidateHistory($newCandidateHistory, $interviewId) {
        ...
        $newCandidateHistory->setPerformedDate($currentTime);
