$(document).ready(function() {
    ...
    var statusId = $('#candidateSearch_vacancyStatus').val();
    ...
    /*Added by sujata*/
    $('#candidateSearch_vacancyStatus').change(function() {
   ...
   $("#candidateSearch_referralName").one('focus', function() {
    ...
    $('#bulkReject').click(function() {
    	$("#frmList_ohrmListComponent").attr("action", rejectUrl);
    });
    $('#changeVacancy').click(function() {
    	$("#frmList_ohrmListComponent").attr("action", changeVacancyUrl);
    });

    $('#btnDelete').attr('disabled', 'disabled');
    $('#bulkReject').attr('disabled', 'disabled');
    ...
    $("#ohrmList_chkSelectAll").click(function() {
        if($(":checkbox").length == 1) {
            ...
            if($("#ohrmList_chkSelectAll").is(':checked')) {
                ...
                $('#bulkReject').removeAttr('disabled', 'disabled');
    ...
    $('#dialogDeleteBtn,#dialogDeleteBtn1,#dialogDeleteBtn2').click(function() {
    	$.blockUI({ 
    		message: $('#domMessage'),
    		css: { 
                border: 'none', 
    ...
    $('#btnDelete').click(function(){
    	$("#frmList_ohrmListComponent").attr("action", deleteUrl);
            ...
            'candidateSearch[dateApplication][to]' : {
                ...
                date_range: function() {
                    return {
                        format:datepickerDateFormat,
                        displayFormat:displayDateFormat,
                        fromDate:$('#candidateSearch_fromDate').val()
                    }
                }
            }
        },
