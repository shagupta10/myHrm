...
class SystemUserService extends BaseService{
    ...
    public function getRecruitmentManagerUsers(){
    	try {
    		return $this->getSystemUserDao()->getRecruitmentManagerUsers();
    	} catch (Exception $e) {
    		throw new ServiceException($e->getMessage(),$e->getCode(),$e);
    	}
    }
    
    public function getUsersByRoles($roleList){
    	 try {
            return $this->getSystemUserDao()->getUsersByRoles($roleList);
        } catch (Exception $e) {
            throw new ServiceException($e->getMessage(),$e->getCode(),$e);
        }
    }
   ...
   /**
     ...
     */
     ...
     public function saveResetPassword($empNo, $key, $password) {
     	return $this->getSystemUserDao()->saveResetPassword($empNo, $key, $password);
     }
     
     public function getUserId($empNumber) {
     	return $this->getSystemUserDao()->getUserId($empNumber);
     }
}