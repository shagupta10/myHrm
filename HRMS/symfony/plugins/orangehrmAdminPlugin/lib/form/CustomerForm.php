...
class CustomerForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
			...
			'supportFunction' => new sfWidgetFormInputCheckbox(),
        ));
        ...
        if (isset($customer) && $customer != null) {
			...
			if ($customer->getSupportFunction() == 1) {
				$this->setDefault('supportFunction', $customer->getSupportFunction());
			}
    ...
    public function save() {
		...
		$customer->setSupportFunction($_POST['addCustomer']['supportFunction']);
        $customer->save();
