...
class viewCertificationsAction extends sfAction {
    ...
    public function execute($request) {
		...
		$this->records = $this->getCertificationService()->getCertificationList();
    ...
    protected function _checkDuplicateEntry() {
        ...
        $object = $this->getCertificationService()->getCertificationByName($this->form->getValue('name'));
