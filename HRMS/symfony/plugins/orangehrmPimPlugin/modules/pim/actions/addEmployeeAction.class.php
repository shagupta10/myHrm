                ...
                if ($this->form->isValid()) {
                    ...
                    try {
                        ...
                        if(!empty($fileType) && !in_array($fileType, $allowedImageTypes)) {
                           ...
                           /*  if($_SESSION['joinMode']=="yes") {
            					$empNumber = $this->form->updateEmployee();
            ...
            if ($request->isMethod('get')) {
            	if(isset($_SESSION['employeeToAdd']))
            	{
            		$emp = $_SESSION['employeeToAdd'];
      				if(isset($_SESSION['passone']))
            			$this->form->applyDefaultEmployeeData($emp);
      				unset($_SESSION['passone']);
      				unset($_SESSION['employeeToAdd']);
            		//$_SESSION['joinMode']="yes";
            	}		
            }
        } 
        else {
