<?php use_stylesheet(plugin_web_path('orangehrmPimPlugin', 'css/contactDetailsSuccess.css')); ?>
...
<script type="text/javascript">
    ...
    var length_exceed = '<?php echo __(ValidationMessages::TEXT_LENGTH_EXCEEDS, array('%amount%' => 250)); ?>';
    var fileModified = 0;
