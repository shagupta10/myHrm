...
abstract class orangehrmMailer {
    ...
    public function  __construct() {
        ...
        $this->transport = Swift_SpoolTransport::newInstance($spool);
    ...
    public function getFooterText() {
		$footerString = "\r\n\n";
		$footerString .="Thank You\t\n";
		$footerString .="SynerzipHRM\t\n\n";
		$footerString .="This is an automated notification. Please do not reply";
		return $footerString;
    }
}
