                    ...
                    <tbody>
                        ...
                        foreach ($dependents as $dependent) :
                            ...
                            <td>
                                ...
                                echo ucfirst(__($dependent->relationship_type)); ?>
                                <?php } else {
...
<script type="text/javascript">
    ...
    function hideShowRelationshipOther() {
       if ($('#dependent_relationshipType').val() == 'father-in-law' || $('#dependent_relationshipType').val() == 'mother-in-law' || $('#dependent_relationshipType').val() == 'child' || $('#dependent_relationshipType').val() == 'father'|| $('#dependent_relationshipType').val() == 'mother' || $('#dependent_relationshipType').val() == 'spouse'|| $('#dependent_relationshipType').val() == '') {
