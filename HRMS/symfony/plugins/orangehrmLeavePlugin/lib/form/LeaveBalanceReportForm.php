...
class LeaveBalanceReportForm extends BaseForm {
    ...
    public function configure() {
        ...
        $this->setWidget('LBR_recordsPer_Page_Limit', new sfWidgetFormInputHidden(array(), array()));
        ...
        $this->setValidator('LBR_recordsPer_Page_Limit', new sfValidatorString(array('required' => false)));
