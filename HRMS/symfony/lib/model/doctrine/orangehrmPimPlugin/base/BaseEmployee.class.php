 ...
 * @method string                    getLinkedInUrl()               Returns the current record's "linkedInUrl" value
 ...
 * @method Employee                  setLinkedInUrl()               Sets the current record's "linkedInUrl" value
...
abstract class BaseEmployee extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('emp_linkedInUrl as linkedInUrl', 'string', 250, array(
             'type' => 'string',
             'length' => 250,
             ));
        ...
        $this->hasColumn('emp_permanent_address as permanentAddress', 'string', 250, array(
             'type' => 'string',
             'default' => '',
             'length' => 250,
             ));
    ...
    public function setUp()
    {
        ...
        $this->hasMany('EmployeeProject', array(
             'local' => 'emp_number',
             'foreign' => 'empNumber'));
    }
}