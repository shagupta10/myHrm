...
use_javascript(plugin_web_path('orangehrmLeavePlugin', 'js/viewLeaveBalanceReportSuccess'));
?>
...
<?php if (!empty($resultsSet)) { ?>
    <div id="report-results" class="box noHeader">
        <div class="inner">
            ...
            <div class="top" >
            	<div class="paginginline">
            	<?php echo '<ul class = "paging top">
            ...
            <div class="bottom">
            	<div class="paginginline">
            	<?php echo '<ul class="paging bottom">
...
<script type="text/javascript">
    ...
    var pageNo = '<?php $pagenumber; ?>';  
    var currentURL = '<?php echo 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']; ?>';
    var lbr_RecordsLimit = '<?php echo $recordsLimit; ?>';
