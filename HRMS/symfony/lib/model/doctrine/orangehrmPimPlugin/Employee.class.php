...
class Employee extends PluginEmployee {
	...
	/**
	 * get the employee Qualification
	 */
	public function getEmployeeQualification(){
		return $this->employeeQualification;
	}
	 ...
	 */
	public function setEmployeeSkills($employeeSkills){
		$this->employeeSkills = $employeeSkills;
	}
	
	/**
	 * Set the employee qualification
	 */
	public function setEmployeeQualification($employeeQualification){
    ...
    */
    public function getFirstAndLastNames() {
        ...
        $fullName = trim(trim($this->firstName) . " " . trim($this->lastName));
    ...
    public function getSupervisorNames() {
        ...
        foreach ($this->supervisors as $supervisor ) {
            ...
            $supervisorNames[] = trim(trim($supervisor->firstName ) . ' ' . $supervisor->lastName);
        }
    ...
    public function getSupervisorRepTo($supervisorEmpNumber) {
        ...
        foreach ($this->supervisors as $repTo) {
            if ($supervisorEmpNumber == $repTo->empNumber) {
                $supRepTo = $repTo;
                break;
            }
        }
