...
class ProjectService extends BaseService {
	 ...
	 * @return type 
	 */
	public function getAllProjects($activeOnly,$searchText=null) {
		return $this->projectDao->getAllProjects($activeOnly,$searchText);
	}
	 ...
	 * @return type 
	 */
	public function getProjectsByCustomerId($customerId,$searchText=null) {
		return $this->projectDao->getProjectsByCustomerId($customerId,$searchText);
	}
