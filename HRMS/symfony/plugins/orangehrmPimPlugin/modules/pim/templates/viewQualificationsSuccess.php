...
<?php use_javascripts_for_form($certificationForm) ?>
<?php use_stylesheets_for_form($certificationForm) ?>
...
<!--    
	...
	include_partial('certification', array('empNumber' => $empNumber, 'form' => $certificationForm, 
        'section' => $section, 'certificationPermissions' => $certificationPermissions));
	?>
