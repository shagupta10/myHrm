...
class ohrmListComponent extends sfComponent {
    ...
    public function execute($request) {
        ...
        if($request->getParameter('recordsPerPage_Limit')){
        	$itemsPerPage = (int)($request->getParameter('recordsPerPage_Limit'));
        }else{
        	$itemsPerPage = self::$itemsPerPage;
        }
       
        $recordsLimit = $itemsPerPage;//sfConfig::get('app_items_per_page');
