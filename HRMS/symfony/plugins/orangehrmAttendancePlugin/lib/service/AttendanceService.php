...
class AttendanceService {
    ...
    public function getAttendanceRecord($employeeId, $fromDate, $toDate) {
        ...
        return $this->getAttendanceDao()->getAttendanceRecord($employeeId, $fromDate, $toDate);
    }
    ...
    public function getAllAttendanceRecordsByDate($date) {
    	return $this->getAttendanceDao()->getAllAttendanceRecordsByDate($date);
    }
    
    public function getAttendanceRecordsBetweenDays($from , $to) {
    	return $this->getAttendanceDao()->getAttendanceRecordsBetweenDays($from , $to);
    }
    ...
    public function deleteAttendanceRecordsByDate($date) {
        return $this->getAttendanceDao()->deleteAttendanceRecordsByDate($date);
    }
    
    public function getAttendanceRecordsByEmployeeAndDate($date, $employee, $accessibleEmployees, $limit, $offset, $isCount = false) {
    	return $this->getAttendanceDao()->getAttendanceRecordsByEmployeeAndDate($date, $employee, $accessibleEmployees, $limit, $offset, $isCount);
    }
}
