            ...
            <div class="mainHeading"><h2><?php echo __("Customer")?></h2></div>
                ...
                <label for="txtSkillName"><?php echo __("Code")?> </label>
             	...
             	<label for="txtDescription"><?php echo __("Description")?></label>
					...
					<br class="clear"/>
				<label for="txtSupportFunction"><?php echo __('Support Function');?></label>
                    <input type="checkbox" id="txtSupportFunction" name="txtSupportFunction" value="<?php echo $customer->getSupportFunction() ?>"></textarea>
                    <br class="clear"/>
