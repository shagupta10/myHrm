        ...
        if ($this->contactDetailsPermission->canUpdate()){
            if ($request->isMethod('post')) {
            	...
            	if ($this->form->isValid()) {
            		$oldEmployee = $this->getEmployeeService()->getEmployee($empNumber);
            		$oldemp = clone $oldEmployee;
                   	$employee = $this->form->getEmployee();
               	 	$this->getEmployeeService()->saveEmployee($employee);
               	 	//$newEmployee = $this->getEmployeeService()->getEmployee($empNumber);
               	 	$this->getEmployeeService()->compareDetails($employee, $oldemp);
