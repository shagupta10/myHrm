...
abstract class PluginWorkflowStateMachine extends BaseWorkflowStateMachine {
    ...
    const RECRUITMENT_APPLICATION_ACTION_HOLD1 = 11;
    const RECRUITMENT_APPLICATION_ACTION_HOLD2 = 12;
    const RECRUITMENT_APPLICATION_ACTION_HOLD3 = 13;
    const RECRUITMENT_APPLICATION_ACTION_INTERVIEW_MISSED = 14;
    const RECRUITMENT_APPLICATION_ACTION_SCREENING = 20;
    const RECRUITMENT_APPLICATION_ACTION_HOLD_BY_SYS = 21;
    const RECRUITMENT_APPLICATION_ACTION_OFFER_JOB_BY_SYS = 22;
    
    //Following action defined in PluginCandidateHistory. Here added just for Reference.
	...
	const RECRUITMENT_CANDIDATE_ACTION_DELETE = 18;
    ...
    public function getRecruitmentActionName($action) {
        ...
        switch ($action) {
            case PluginWorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_ATTACH_VACANCY:
                $actionName = "Application Initiated"; // "Assigned a Vacancy";
                break;
