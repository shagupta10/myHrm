...
?>
<?php 
use_javascript(plugin_web_path('orangehrmLeavePlugin', 'js/viewLeaveEntitlementsSuccess')); 
?>
...
<script type="text/javascript">
    ...
    var lang_Entitlement_ErrMsg = '<?php echo __(ValidationMessages::REQUIRED); ?>';
    var lang_Entitlement_Default = '<?php echo __(ValidationMessages::REQUIRED); ?>';
    var btnAddURL = '<?php echo url_for('leave/addLeaveEntitlement') ?>?savedsearch=1';
</script>
