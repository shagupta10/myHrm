            ...
            <fieldset>
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <?php echo $form['keyWords']->render(array("placeholder" => "Enter comma separated words...", "class" => "keyWords inputFormatHint")); ?>
                    </li>
                    	<?php echo $form['recordsPer_Page_Limit']->render(); ?>
                </ol>
...
<script type="text/javascript">
    function submitPage(pageNo) {
    	document.frmSrchJobVacancy.pageNo.value = pageNo;
        document.frmSrchJobVacancy.hdnAction.value = 'paging';
    ...
    var deleteJobVacancyUrl = '<?php echo url_for('recruitment/deleteJobVacancy'); ?>';
