 ...
 * @method integer             getDaysLimit()                            Returns the current record's "days_limit" value
 ...
 * @method LeaveType           setDaysLimit()                            Sets the current record's "days_limit" value
 * @package    orangehrm
...
abstract class BaseLeaveType extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
		...
		$this->hasColumn ( 'days_limit', 'integer', 2, array (
			'type' => 'integer',
			'fixed' => 0,
			'unsigned' => false,
			'primary' => false,
