...
class ConfigService extends BaseService {
    ...
    /*Added by Sujata for Performance Review Configuration */
    const KEY_PERFORMANCE_CYCLE_LENGTH = 'performance_cycle_length';
    const KEY_ONE_ON_ONE_REVIEW_DAYS = 'one_on_one_review_days';
    const KEY_SELF_REVIEW_DAYS = 'self_review_days';
    const KEY_REVIEW_DUE_DAYS = 'review_due_days';
    ...
    /*Added by Sujata for set and get methods of Performance Review Configuration */
    public function getPerformanceCycleLength() {
        return $this->_getConfigValue(self::KEY_PERFORMANCE_CYCLE_LENGTH);
    }
    
    public function setPerformanceCycleLength($months) {
        $this->_setConfigValue(self::KEY_PERFORMANCE_CYCLE_LENGTH, $months);
    }  
    
    public function getOneOnOneReviewDays() {
        return $this->_getConfigValue(self::KEY_ONE_ON_ONE_REVIEW_DAYS);
    }
    
    public function setOneOnOneReviewDays($daysBefore) {
        $this->_setConfigValue(self::KEY_ONE_ON_ONE_REVIEW_DAYS, $daysBefore);
    }
    
    public function getSelfReviewDays() {
        return $this->_getConfigValue(self::KEY_SELF_REVIEW_DAYS);
    }
    
    public function setSelfReviewDays($daysBefore) {
        $this->_setConfigValue(self::KEY_SELF_REVIEW_DAYS, $daysBefore);
    }
        
    public function getReviewDueDays() {
        return $this->_getConfigValue(self::KEY_REVIEW_DUE_DAYS);
    }
    
    public function setReviewDueDays($daysAfter) {
        $this->_setConfigValue(self::KEY_REVIEW_DUE_DAYS, $daysAfter);
    }
}