 ...
 * @property text $keySkills
 * @property text $goodToHaveSkills
 ...
 * @method text                getKeySkills()            Returns the current record's "keySkills" value
 * @method text                getGoodToHaveSkills()     Returns the current record's "goodToHaveSkills" value
 ...
 * @method JobVacancy          setExperience()           Sets the current record's "experience" value
 * @method JobVacancy          setKeySkills()            Sets the current record's "keySkills" value
 * @method JobVacancy          setGoodToHaveSkills()     Sets the current record's "goodToHaveSkills" value
...
abstract class BaseJobVacancy extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('experience', 'string', 30, array(
              'type' => 'string',
              'length' => 30,
             ));
        $this->hasColumn('keySkills', 'text', null, array(
        	  'type' => 'text',
        	 ));
        $this->hasColumn('goodToHaveSkills', 'text', null, array(
        		'type' => 'text',		              
             ));		              
        ...
        $this->hasColumn('flag_for_vacancy as flagForResume', 'integer', 4, array(
        		'type' => 'integer',
             	'length' => 4,
        ));
        $this->hasColumn('consultants as consultants', 'string', 200, array(
        		'type' => 'string',
        		'length' => 200,
        ));
        $this->hasColumn('is_urgent as isUrgent', 'integer', 1, array(
        		'type' => 'integer',
        		'length' => 1,
        ));
        $this->hasColumn('projects as projects', 'string', 100, array(
        		'type' => 'string',
        		'length' => 100,
        ));
    }
    ...
    public function setUp()
    {
        ...
        $this->hasMany('JobVacancyHiringManager', array(
             'local' => 'id',
             'foreign' => 'vacancyId'));
    }
}