...
class CandidateService extends BaseService {
    ...
    public function searchJobCandidateRequests($searchParam){
	    return $this->getCandidateDao()->searchJobCandidateRequests($searchParam);
    }
    
    public function getCandidateListForRequest(){
    	return $this->getCandidateDao()->getCandidateListForRequest();
    }
    
    public function getCandidateRequestRecordsCount($searchParam){
	    return $this->getCandidateDao()->getCandidateRequestRecordsCount($searchParam);
    }
    
    public function searchCandidatesReferred($searchParam) {
    	$searchCandidateQuery = $this->buildSearchQueryReferred($searchParam);
    	return $this->getCandidateDao()->searchCandidatesReferred($searchCandidateQuery);
    }
    ...
    /**
     * Retrive the referral count
     */
    public function getReferralRecordCount($parameterObject){
	    $query = $this->getCandidateDao()->buildSearchQueryForReferrals($parameterObject, true);
	    ...
	    return $this->getCandidateDao()->getCandidateRecordsCount($query);    	
    }
    ...
    /**
     * Get request details of given request ID
     */
    public function getRequestDetails($requestIds){
    	return $this->candidateDao->getRequestDetails($requestIds);
    }
    ...
    protected function buildSearchQueryReferred($parameterObject) {
    	$query = $this->getCandidateDao()->buildSearchQueryForReferrals($parameterObject);
    	$serviceName = 'CandidateService';
    	$methodName = 'searchCandidatesReferred';
    	$query = $this->decorateQuery($serviceName, $methodName, $query, $parameterObject->getAdditionalParams());
    	return $query;
    }
    ...
    public function getReferredCandidate($referredby){
    	return $this->getCandidateDao()->getReferredCandidate($referredby);
    }
  
    public function getLatestScheduledInterview($id){
    	return $this->getCandidateDao()->getLatestScheduledInterview($id);
    }
    
    public function getCurrentScheduledInterviewHiringMgr($empNumber,$convertDate){
    	return $this->getCandidateDao()->getCurrentScheduledInterviewHiringMgr($empNumber,$convertDate);
    }
    public function getCurrentScheduledInterviewInterviewer($empNumber,$convertDate){
    	return $this->getCandidateDao()->getCurrentScheduledInterviewInterviewer($empNumber,$convertDate);
    }
    public function getPendingFeedbackHiringMgr($empNo,$convertDate){
    	return $this->getCandidateDao()->getPendingFeedbackHiringMgr($empNo,$convertDate);
    }
    public function getPendingFeedbackInterviewer($empNo,$convertDate){
    	return $this->getCandidateDao()->getPendingFeedbackInterviewer($empNo,$convertDate);
    }
    public function performBulkReject($ids){
    	return $this->getCandidateDao()->performBulkReject($ids);
    }
    
//    public function changeCandidateVacancy($mappingArray, $vacancyDetails, $interviewerArray){
//    	return $this->getCandidateDao()->changeCandidateVacancy($mappingArray, $vacancyDetails, $interviewerArray);
//    }
    
    public function changeCandidateVacancy($changeVacancyDetails, $fromPage){
    	return $this->getCandidateDao()->changeCandidateVacancy($changeVacancyDetails, $fromPage);
    }
    ...
    public function saveJobCandidateRequests(JobCandidateRequests $jobCandidateRequests) {
        return $this->candidateDao->saveJobCandidateRequests($jobCandidateRequests);
    }
    ...
    public function updateJobCandidateRequests($jobCandidateRequests) {
        return $this->candidateDao->updateJobCandidateRequests($jobCandidateRequests);
    }
     ...
     * @return <type>
     */
    public function deleteJobCandidateRequests($jobCandidateRequests) {
        return $this->candidateDao->deleteJobCandidateRequests($jobCandidateRequests);
	...
	public function searchAgencyCandidatesReferred() {
		return $this->candidateDao->searchAgencyCandidatesReferred ();
	}
	
	/**
	 */
	public function getCountsSarchAgencyCandidatesReferred() {
		return $this->candidateDao->getCountsSarchAgencyCandidatesReferred ();
	}
    ...
    public function getCandidateByEmail($email,$id=null) {
        return $this->candidateDao->getCandidateByEmail($email,$id);
    }
    public function isExistCandidateVacancy($candidate,$vacancyId) {
        return $this->candidateDao->isExistCandidateVacancy($candidate,$vacancyId);
    }
    public function getCandidateAttachment($candidateId) {
        return $this->candidateDao->getCandidateAttachment($candidateId);
    }
    public function getCandidateVacancy($candidateId) {
        return $this->candidateDao->getCandidateVacancy($candidateId);
    }
    public function getCandidateByCandidateIdAndVacancyId($candidateId,$vacancyId) {
        return $this->candidateDao->getCandidateByCandidateIdAndVacancyId($candidateId,$vacancyId);
    }
    public function getVacanciesInArrayByCandidateId($candidateId) {
        return $this->candidateDao->getVacanciesInArrayByCandidateId($candidateId);
    }
    public function isOnlyInterviewer($candidateId) {
        return $this->candidateDao->isOnlyInterviewer($candidateId);
	}
    public function getCandidateByContactNumber($contactNumber,$id=null) {
        return $this->candidateDao->getCandidateByContactNumber($contactNumber,$id);
    }
    public function updateCandidatesOtherVacancies(JobCandidateVacancy $candidateVacancy, $status,$action,$noEffectOnRejected=false) {        
       return $this->candidateDao->updateCandidatesOtherVacancies($candidateVacancy,$status,$action,$noEffectOnRejected);
    }
}
