...
<div class="box" id="jobInterview">
    ...
    <div class="inner">
        ...
        <div class="message warning" id="interviewer_unavailable_blk" style="display: none;">
			Sorry..!! Following Interviewer(s) are busy with other interviews at this time slot. 
    	 	Please select alternate time slot
    	 	<ul id="interviewer_unavailable_list" style="padding-top: 1%; line-height: 1.5; list-style: inside none circle;">
    	 	
    	 	</ul>
	</div>
		
        <form name="frmJobInterview" id="frmJobInterview" method="post" action="<?php echo url_for('recruitment/jobInterview?candidateVacancyId=' . $form->candidateVacancyId . '&selectedAction=' . $form->selectedAction . '&interviewId=' . $interviewId); ?>" onsubmit="return checkIfInterviewerAvailable();">
            ...
            <fieldset>
                <ol>
                    ...
                    <li>
                        <?php echo $form['note']->renderLabel(__('Notes'.' <em>*</em>'), array('class' => 'firstLabel')); ?>
...
<script type="text/javascript">
    ...
    var isInterviewerAvailable = '<?php echo sfContext::getInstance()->getRequest()->getUriPrefix().sfContext::getInstance()->getRequest()->getRelativeUrlRoot().'/index.php/recruitment/InterviewerAvailable' ?>';
    ...
    var lang_noteRequired = '<p id="noteReq" style="margin-top:116%;">Required</p>';
    ...
    var lang_timeRequired = '<?php echo __(ValidationMessages::REQUIRED); ?>';
