...
class Google_Auth_OAuth2 extends Google_Auth_Abstract
{
  ...
  const USER_GET_DATA = 'https://www.googleapis.com/plus/v1/people/me/openIdConnect';
  ...
  public function get_user_data($access_token) {	
	$param = self::USER_GET_DATA . "?access_token=" .$access_token;
	$request = new Google_Http_Request($param);
	$response = $this->client->getIo()->makeRequest($request);	
