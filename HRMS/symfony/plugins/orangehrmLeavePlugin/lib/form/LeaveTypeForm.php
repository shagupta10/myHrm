...
class LeaveTypeForm extends orangehrmForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
            ...
            'txtLeaveDaysLimit' => new sfWidgetFormInput(array(), array('size' => 2)),
        ...
        $this->getWidgetSchema()->setLabel('txtLeaveDaysLimit', __('Days') .' <em>*</em>');
        $this->setValidators(array(
            'txtLeaveTypeName' => 
        		...
        		new sfValidatorInteger(array(
        				...
        				array(
        						'required' => __('Required'),
        						'min' => __('Minimum days of leaves allowed is 0'),
        						'max' => __('Maximum days of leaves allowed are 90')
        				)),
    ...
    public function setDefaultValues($leaveTypeId) {
        ...
        if ($leaveTypeObject instanceof LeaveType) {
            ...
            $this->setDefault('txtLeaveDaysLimit', $leaveTypeObject->getDaysLimit());
        }
    }
    ...
    public function getLeaveTypeObject() {
        ...
        $leaveType->setDaysLimit($this->getValue('txtLeaveDaysLimit'));
        return $leaveType;        
    }
