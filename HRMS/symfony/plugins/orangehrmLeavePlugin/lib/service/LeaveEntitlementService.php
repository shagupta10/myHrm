...
class LeaveEntitlementService extends BaseService {
    ...
    public function searchEmployeeJoiningDate($empNumber) {

        return $this->getLeaveEntitlementDao()->searchEmployeeJoiningDate($empNumber);
    }
    ...
    public function deleteLeaveEntitlements($ids) {
        ...
        foreach($ids as $key => $key_value) {
        	$entitlement = $this->getLeaveEntitlement($key_value);
    ...
    public function getMatchingEntitlements($empNumber, $leaveTypeId, $fromDate, $toDate) {
     ...
     public function isDifferentLeavePeriodDates($fromDate,$toDate,$empId) {
        return $this->getLeaveEntitlementDao()->isDifferentLeavePeriodDates($fromDate,$toDate,$empId);
    }
