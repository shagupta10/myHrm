...
class CandidateHistoryService {
    ...
    public function getCandidateHistoryRecord($object) {
        ...
        $array = array(WorkflowStateMachine::RECRUITMENT_CANDIDATE_ACTION_ADD, WorkflowStateMachine::RECRUITMENT_CANDIDATE_ACTION_APPLY, WorkflowStateMachine::RECRUITMENT_CANDIDATE_ACTION_REMOVE, WorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_ATTACH_VACANCY, WorkflowStateMachine::RECRUITMENT_CANDIDATE_ACTION_DELETE);
    ...
    public function getCandidateHistoryDescription($object) {
        ...
        switch ($object->getAction()) {
            ...
            case PluginWorkflowStateMachine::RECRUITMENT_CANDIDATE_ACTION_ADD:
                $description = $this->getDescriptionForAdd($object);
                break;
            case PluginWorkflowStateMachine::RECRUITMENT_CANDIDATE_ACTION_APPLY:
                $description = $this->getDescriptionForApply($object);
                break;
            case PluginWorkflowStateMachine::RECRUITMENT_CANDIDATE_ACTION_REMOVE:
            ...
            case PluginWorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_INTERVIEW_MISSED:
                $description = $this->getDescriptionForInterviewMissed($object);
                break;
            ...
            case PluginWorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_HOLD1:
                $description = $this->getDescriptionForHold($object);
                break;
            ...
            case PluginWorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_HOLD3:
                $description = $this->getDescriptionForHold($object);
                break;
            case PluginWorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_HOLD_BY_SYS:
                $description = $this->getDescriptionForHold($object);
                break;
            case PluginWorkflowStateMachine::RECRUITMENT_CANDIDATE_ACTION_DELETE:
                $description = $this->getDescriptionForDelete($object);
                break;
            case PluginWorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_OFFER_JOB_BY_SYS:
                $description = $this->getDescriptionForOfferJob($object);
                break;
            case PluginWorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_SCREENING:
                $description = $this->getDescriptionForScreening($object);    
        }
        return $description;
    }
    ...
    public function getDescriptionForDelete($object) {
    	return __($object->getPerformerName()) . " " . __("deleted") . " " . $object->getJobCandidate()->getFullName();
    }
    ...
    public function getDescriptionForScreening($object) {
        return __($object->getPerformerName()) . " " . __("activated candidature again for the job vacancy")." ".$object->getCandidateVacancyName();
    }
    ...
    $employeeService = new EmployeeService();
        for($i=0; $i < sizeof($interviewers)-1; $i++){
            $interviewersNameList[] = $employeeService->getEmployee($interviewers[$i])->getFirstAndLastNames();
        }
    ...
    public function getDescriptionForInterviewMissed($object) {
        $interviewId = $object->getInterviewId();
        $jobInterview = $this->getInterviewService()->getInterviewById($interviewId);
        return __($object->getPerformerName()) . " " . __("marked") . " " . $jobInterview->getInterviewName() . " " . __("missed")." ".__("for")." ".$object->getCandidateVacancyName();
    }
    ...
    public function getDescriptionForHold($object) {
        return __($object->getPerformerName()) . " " . __("Keep on Hold") . " " . $object->getJobCandidate()->getFullName()." ".__("for")." ".$object->getCandidateVacancyName();
    }
