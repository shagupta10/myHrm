...
class jobCategoryAction extends sfAction {
	...
	public function execute($request) {
		...
		$this->_setListComponent($jobCatList, $noOfRecords, $pageNumber);
	...
	private function _setListComponent($jobCatList, $noOfRecords, $pageNumber) {
		...
		ohrmListComponent::setNumberOfRecords(count($this->getJobCategoryService()->getJobCategoryList()));
	}
}
