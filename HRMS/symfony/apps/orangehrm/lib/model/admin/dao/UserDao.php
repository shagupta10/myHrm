...
class UserDao extends BaseDao {
   ...
   public function saveResetPasswordDetails($empNo, $key) {
   	try {
   		...
   		$resetPassword->setEmpId($empNo);
   		$resetPassword->setUniqueKey($key);
   		$resetPassword->setCreatedTime($stamp);
   		$resetPassword->setActive(ResetPassword::ACTIVE);
   		$resetPassword->save();
   ...
   public function getEmpNumberIfTokenActive($key) {
