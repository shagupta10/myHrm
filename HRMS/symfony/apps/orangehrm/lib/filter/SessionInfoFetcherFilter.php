...
class SessionInfoFetcherFilter extends sfFilter {
    ...
    public function execute($filterChain) {
        ...
        if (isset($_SESSION['isConsultant'])) {
            $userRoleArray['isConsultant'] = $_SESSION['isConsultant'];
        }
        
        if (isset($_SESSION['isRecruitmentManager'])) {
	        $userRoleArray['isRecruitmentManager'] = $_SESSION['isRecruitmentManager'];
        }
