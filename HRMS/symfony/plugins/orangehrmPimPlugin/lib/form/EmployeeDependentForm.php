...
class EmployeeDependentForm extends BaseForm {
    ...
    public function getDependentWidgets(){
        ...
        $relationshipChoices = array('' => "-- " . __('Select') . " --", 'father'=> $i18nHelper->__('Father'),'mother'=> $i18nHelper->__('Mother'),'spouse'=> $i18nHelper->__('Spouse'),'child'=> $i18nHelper->__('Child'), 'father-in-law'=> $i18nHelper->__('Father-in-law'),'mother-in-law'=> $i18nHelper->__('Mother-in-law'),'other'=> $i18nHelper->__('Other'));
    ...
    public function getDependentValidators(){
        ...
        $i18nHelper = sfContext::getInstance()->getI18N();
        $relationshipChoices = array('' => "-- " . __('Select') . " --", 'child'=> $i18nHelper->__('Child'), 'father'=> $i18nHelper->__('Father'),'mother'=> $i18nHelper->__('Mother'),'father-in-law'=> $i18nHelper->__('Father-in-law'),'mother-in-law'=> $i18nHelper->__('Mother-in-law'),'spouse'=> $i18nHelper->__('Spouse'),'other'=> $i18nHelper->__('Other'));
