...
class VacancyService extends BaseService {
    ...
    public function getVacancyListForJobTitle($jobTitle, $allowedVacancyList, $asArray = false, $status = '') {
        return $this->getVacancyDao()->getVacancyListForJobTitle($jobTitle, $allowedVacancyList, $asArray, $status);
    }
    ...
    public function getVacancyPropertyListReferred($empNo) {
    	return $this->getVacancyDao()->getVacancyPropertyListReferred($empNo);
    }
    ...
    public function getVacancyDescriptionById($id) {
    	return $this->getVacancyDao()->getVacancyDescriptionById($id);
    }
    
    public function getActiveCandidateCountByVacancyId($id) {
    	return $this->getVacancyDao()->getActiveCandidateCountByVacancyId($id);
    }
    
    public function getVacancyByCandidateId($id,$getCandidateVacancy=false) {
    	$row = $this->getVacancyDao()->getVacancyByCandidateId($id);
    	if($getCandidateVacancy)
    		return $row;
    	else
    		return  $this->getVacancyById($row['vacancyId']);
    }
}
