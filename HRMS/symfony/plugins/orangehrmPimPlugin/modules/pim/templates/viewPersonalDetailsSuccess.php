                ...
                <fieldset>
                    ...
                    <ol>
                    	<li>
                         ...
                         <li>
                             <?php echo $form['txtEmpHusbandName']->renderLabel(__("Spouse's Name")); ?>
                             <?php echo $form['txtEmpHusbandName']->render(array("class" => "block default editable", "maxlength" => 100, "title" => __('Spouse Name'))); ?>
                        </li>
                    </ol>
                    <ol>
                        <li>
                    ...
                    <ol>
                    	<li style="width:70%">
                            <label for="personal_linkedIn"><?php echo __("Linked In URL"); ?></label>
                            <?php echo $form['linkedIn']->render(array("class"=>"editable","maxlength" => 200, "style"=>"width:50%")); ?>
                        </li>
