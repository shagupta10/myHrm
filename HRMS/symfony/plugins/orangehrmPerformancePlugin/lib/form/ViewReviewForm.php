...
class ViewReviewForm extends BaseForm {
    ...
    private $projectJson = array();

    public function configure() {
        $this->empJson = $this->getOption('empJson');
        $this->projectJson = $this->getOption('projectJson');
        $this->widgetSchema->setNameFormat('viewReviewForm[%s]');
        $this->approvedJson = $this->getOption('approvedJson');
    }
    ...
    public function getApprovedReviewsListAsJson() {
        return $this->approvedJson;
    }
}