...
<div id="searchProject" class="box searchForm toggableForm">
    ...
    <div class="inner">
        <form name="frmSearchProject" id="frmSearchProject" method="post" action="<?php echo url_for('admin/viewProjects?recordsPerPage_Limit='.$getRecordsLimit); ?>" >
...
<form name="frmHiddenParam" id="frmHiddenParam" method="post" action="<?php echo url_for('admin/viewProjects?recordsPerPage_Limit='.$getRecordsLimit); ?>">
