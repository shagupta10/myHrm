...
class CustomerService extends BaseService {
    ...
    public function getAllCustomerList(){
    	return $this->customerDao->getAllCustomerList();
    }
    ...
    public function getCustomerListAsJson() {
	    $jsonArray = array();
	    $customers = $this->getAllCustomers(true);
    ...
    public function getEmployeesByCustomerId($customerId) {
    	return $this->customerDao->getEmployeesByCustomerId($customerId);
    }
