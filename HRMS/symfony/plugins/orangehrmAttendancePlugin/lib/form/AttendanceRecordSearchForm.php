...
class AttendanceRecordSearchForm extends sfForm {
    ...
    public function configure() {
        ...
        $this->setWidgets(array(
        	...
        	'dateRange' => new ohrmWidgetFormDateRange(array(  
                    'from_date' => new ohrmWidgetDatePicker(array(), array('id' => 'attendance_fromDate')),  
                    'to_date' => new ohrmWidgetDatePicker(array(), array('id' => 'attendance_toDate')),
                    'from_label' => 'From',
                    'to_label' => 'To'
                )),
        	'recordsPerPageLimit' => new sfWidgetFormInputHidden(array(), array())
        ));
        ...
        $this->setValidators(array(
            ...
            'recordsPerPageLimit' => new sfValidatorString(array('required' => false))
        ));
