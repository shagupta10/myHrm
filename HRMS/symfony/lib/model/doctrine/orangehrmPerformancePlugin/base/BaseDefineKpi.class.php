 ...
 * @method string    getKpiTitle()     Returns the current record's "KpiTitle" value
 ...
 * @method DefineKpi setKpiTitle()     Sets the current record's "KpiTitle" value
 ...
 * @method DefineKpi setRatings()      Sets the current record's "ratings" value
...
abstract class BaseDefineKpi extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('kpi_title as KpiTitle', 'string', 100, array(
             'type' => 'string',
             ));
        $this->hasColumn('description as desc', 'string', null, array(
             'type' => 'string',
             'length' => 200,
             ));
        ...
        $this->hasColumn('rating_description as ratings', 'string', null, array(
             'type' => 'string',
             ));
