...
class HolidayService extends BaseService {
    ...
    // get upcoming public holidays within next 7 days
    public function getUpcomingPublicHolidayList(){
    	return $this->getHolidayDao()->getUpcomingPublicHolidayList();
    }
    /**
     * Delete Holiday
     * @param int $holidayId
    ...
    public function searchHolidays($startDate = null, $endDate = null, $offset = 0, $limit = 10 ,$getcount = false) {
        if($getcount){
        	return $holidayList = $this->getHolidayDao()->searchHolidays($startDate, $endDate, $offset, $limit,true);
        }
        $holidayList = $this->getHolidayDao()->searchHolidays($startDate, $endDate, $offset, $limit);
