...
$(document).ready(function() {
    ...
    $("#addButton").live('click', function(){
        ...
        if ($('#addProject_projectAdmin_'+index+'_empName').val() == '' || $('#addProject_projectAdmin_'+index+'_empName').val() == lang_typeHint) {
            $('#addProject_projectAdmin_'+index+'_empName').addClass("inputFormatHint").val(lang_typeHint);
        }
    });
    ...
    $('.removeText').live('click', function(){
        ...
        $('#addProject_projectAdmin_'+result+'_empName').val("");
        $('#addProject_projectAdmin_'+result+'_empId').val("");
        $('#addProject_projectAdminType_'+result).val("");
    ...
    if(projectId>0){
        for(var i=2; i<=adminCount; i++){
            $('#projectAdmin_'+(i)).show();
            $('#projectAdminType_'+(i)).show();
