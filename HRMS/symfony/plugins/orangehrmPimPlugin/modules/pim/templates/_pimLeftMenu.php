...
<div id="sidebar">
    ...
    <ul id="sidenav">
       ...
       <?php // viewReportToDetails
        ...
        <?php //Added link for change project/Repot-to
            $dataGroupPermission = $userRoleManager->getDataGroupPermissions(array('supervisor','subordinates','report-to_attachment','report-to_custom_fields'), array(), array(), $self, $entities);
            if($dataGroupPermission->canRead()) :
        ?>        
            <li<?php echo getListClassHtml('changeProject'); ?>><a href="<?php echo url_for('pim/changeProject?empNumber=' . $empNumber);?>"><?php echo __("Project/Report-to"); ?></a></li>
        <?php endif; ?>  
