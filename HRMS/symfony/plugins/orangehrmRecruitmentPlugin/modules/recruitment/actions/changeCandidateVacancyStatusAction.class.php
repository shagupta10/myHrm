...
class changeCandidateVacancyStatusAction extends baseRecruitmentAction {
    ...
    public function execute($request) {
        ...
        if (!empty($id)) {
            ...
            if($action == WorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_MARK_INTERVIEW_FAILED || $action == WorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_MARK_INTERVIEW_PASSED) {
            	$this->flag = true;
            }
        	...
        	if($this->selectedAction == WorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_MARK_INTERVIEW_FAILED || $this->selectedAction == WorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_MARK_INTERVIEW_PASSED) {
        		$this->flag = true;
        	}
        }
        $param = array();
...
//        }
        if ($request->isMethod('post')) {
            ...
            if ($this->form->isValid()) {
	            ...
	            if ($this->form->selectedAction == WorkflowStateMachine::RECRUITMENT_APPLICATION_ACTION_HIRE)
	            {
