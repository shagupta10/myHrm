...
class OrangeConfig {
    ...
    public function getAppConfValue($key) {
        ...
        switch ($key) {
            ...
            case ConfigService::KEY_LEAVE_PERIOD_STATUS:
                ...
                break;
            /*Added by Sujata */
            case ConfigService::KEY_PERFORMANCE_CYCLE_LENGTH:
                return $configService->getPerformanceCycleLength();
                break;
			case ConfigService::KEY_ONE_ON_ONE_REVIEW_DAYS:
                return $configService->getOneOnOneReviewDays();
                break;
            case ConfigService::KEY_SELF_REVIEW_DAYS:
                return $configService->getSelfReviewDays();
                break;
            case ConfigService::KEY_REVIEW_DUE_DAYS:
                return $configService->getReviewDueDays();
                break;
    ...
    public function setAppConfValue($key, $value) {
        ...
        switch ($key) {
            ...
            /*Added by Sujata */
            case ConfigService::KEY_PERFORMANCE_CYCLE_LENGTH:
                 return $configService->setPerformanceCycleLength($value);
                break;
			case ConfigService::KEY_ONE_ON_ONE_REVIEW_DAYS:
                 return $configService->setOneOnOneReviewDays($value);
                break;
            case ConfigService::KEY_SELF_REVIEW_DAYS:
                 return $configService->setSelfReviewDays($value);
                break;
            case ConfigService::KEY_REVIEW_DUE_DAYS:
                 return $configService->setReviewDueDays($value);
                break;
